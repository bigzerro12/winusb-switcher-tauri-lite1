...
#define JLINKARM_TIF_NUMTIFS           12
...
#define JLINK_SPI_FLAG_CS_INDEX_0                 (0 << 5)
#define JLINK_SPI_FLAG_CS_INDEX_1                 (1 << 5)
#define JLINK_SPI_FLAG_CS_INDEX_2                 (2 << 5)
#define JLINK_SPI_FLAG_CS_INDEX_3                 (3 << 5)
...
#define JLINK_CORE_RX66N            0x0D0CFFFF
...
#define JLINKARM_EMU_CAP_EX_CMSIS_DAP_HID           (74)
#define JLINKARM_EMU_CAP_EX_TIF_UART                (75)
#define JLINKARM_EMU_CAP_EX_FIXED_VTREF_TMP         (76)            // Supports temporary fixed VTref feature
...
//
// JLINKARM_CORTEX_R8_REG
//
typedef enum {
    JLINKARM_CORTEX_R8_REG_R0,          // Index  0
    JLINKARM_CORTEX_R8_REG_R1,          // Index  1
    JLINKARM_CORTEX_R8_REG_R2,          // Index  2
    JLINKARM_CORTEX_R8_REG_R3,          // Index  3
    JLINKARM_CORTEX_R8_REG_R4,          // Index  4
    JLINKARM_CORTEX_R8_REG_R5,          // Index  5
    JLINKARM_CORTEX_R8_REG_R6,          // Index  6
    JLINKARM_CORTEX_R8_REG_R7,          // Index  7
    JLINKARM_CORTEX_R8_REG_CPSR,        // Index  8
    JLINKARM_CORTEX_R8_REG_R15,         // Index  9
    JLINKARM_CORTEX_R8_REG_R8_USR,      // Index 10
    JLINKARM_CORTEX_R8_REG_R9_USR,      // Index 11
    JLINKARM_CORTEX_R8_REG_R10_USR,     // Index 12
    JLINKARM_CORTEX_R8_REG_R11_USR,     // Index 13
    JLINKARM_CORTEX_R8_REG_R12_USR,     // Index 14
    JLINKARM_CORTEX_R8_REG_R13_USR,     // Index 15
    JLINKARM_CORTEX_R8_REG_R14_USR,     // Index 16
    JLINKARM_CORTEX_R8_REG_SPSR_FIQ,    // Index 17
    JLINKARM_CORTEX_R8_REG_R8_FIQ,      // Index 18
    JLINKARM_CORTEX_R8_REG_R9_FIQ,      // Index 19
    JLINKARM_CORTEX_R8_REG_R10_FIQ,     // Index 20
    JLINKARM_CORTEX_R8_REG_R11_FIQ,     // Index 21
    JLINKARM_CORTEX_R8_REG_R12_FIQ,     // Index 22
    JLINKARM_CORTEX_R8_REG_R13_FIQ,     // Index 23
    JLINKARM_CORTEX_R8_REG_R14_FIQ,     // Index 24
    JLINKARM_CORTEX_R8_REG_SPSR_SVC,    // Index 25
    JLINKARM_CORTEX_R8_REG_R13_SVC,     // Index 26
    JLINKARM_CORTEX_R8_REG_R14_SVC,     // Index 27
    JLINKARM_CORTEX_R8_REG_SPSR_ABT,    // Index 28
    JLINKARM_CORTEX_R8_REG_R13_ABT,     // Index 29
    JLINKARM_CORTEX_R8_REG_R14_ABT,     // Index 30
    JLINKARM_CORTEX_R8_REG_SPSR_IRQ,    // Index 31
    JLINKARM_CORTEX_R8_REG_R13_IRQ,     // Index 32
    JLINKARM_CORTEX_R8_REG_R14_IRQ,     // Index 33
    JLINKARM_CORTEX_R8_REG_SPSR_UND,    // Index 34
    JLINKARM_CORTEX_R8_REG_R13_UND,     // Index 35
    JLINKARM_CORTEX_R8_REG_R14_UND,     // Index 36
    JLINKARM_CORTEX_R8_REG_FPSID,       // Index 37
    JLINKARM_CORTEX_R8_REG_FPSCR,       // Index 38
    JLINKARM_CORTEX_R8_REG_FPEXC,       // Index 39
    JLINKARM_CORTEX_R8_REG_FPS0,        // Index 40
    JLINKARM_CORTEX_R8_REG_FPS1,        // Index 41
    JLINKARM_CORTEX_R8_REG_FPS2,        // Index 42
    JLINKARM_CORTEX_R8_REG_FPS3,        // Index 43
    JLINKARM_CORTEX_R8_REG_FPS4,        // Index 44
    JLINKARM_CORTEX_R8_REG_FPS5,        // Index 45
    JLINKARM_CORTEX_R8_REG_FPS6,        // Index 46
    JLINKARM_CORTEX_R8_REG_FPS7,        // Index 47
    JLINKARM_CORTEX_R8_REG_FPS8,        // Index 48
    JLINKARM_CORTEX_R8_REG_FPS9,        // Index 49
    JLINKARM_CORTEX_R8_REG_FPS10,       // Index 50
    JLINKARM_CORTEX_R8_REG_FPS11,       // Index 51
    JLINKARM_CORTEX_R8_REG_FPS12,       // Index 52
    JLINKARM_CORTEX_R8_REG_FPS13,       // Index 53
    JLINKARM_CORTEX_R8_REG_FPS14,       // Index 54
    JLINKARM_CORTEX_R8_REG_FPS15,       // Index 55
    JLINKARM_CORTEX_R8_REG_FPS16,       // Index 56
    JLINKARM_CORTEX_R8_REG_FPS17,       // Index 57
    JLINKARM_CORTEX_R8_REG_FPS18,       // Index 58
    JLINKARM_CORTEX_R8_REG_FPS19,       // Index 59
    JLINKARM_CORTEX_R8_REG_FPS20,       // Index 60
    JLINKARM_CORTEX_R8_REG_FPS21,       // Index 61
    JLINKARM_CORTEX_R8_REG_FPS22,       // Index 62
    JLINKARM_CORTEX_R8_REG_FPS23,       // Index 63
    JLINKARM_CORTEX_R8_REG_FPS24,       // Index 64
    JLINKARM_CORTEX_R8_REG_FPS25,       // Index 65
    JLINKARM_CORTEX_R8_REG_FPS26,       // Index 66
    JLINKARM_CORTEX_R8_REG_FPS27,       // Index 67
    JLINKARM_CORTEX_R8_REG_FPS28,       // Index 68
    JLINKARM_CORTEX_R8_REG_FPS29,       // Index 69
    JLINKARM_CORTEX_R8_REG_FPS30,       // Index 70
    JLINKARM_CORTEX_R8_REG_FPS31,       // Index 71
    JLINKARM_CORTEX_R8_REG_MVFR0,       // Index 72
    JLINKARM_CORTEX_R8_REG_MVFR1,       // Index 73
    JLINKARM_CORTEX_R8_REG_R8,          // Index 74
    JLINKARM_CORTEX_R8_REG_R9,          // Index 75
    JLINKARM_CORTEX_R8_REG_R10,         // Index 76
    JLINKARM_CORTEX_R8_REG_R11,         // Index 77
    JLINKARM_CORTEX_R8_REG_R12,         // Index 78
    JLINKARM_CORTEX_R8_REG_R13,         // Index 79
    JLINKARM_CORTEX_R8_REG_R14,         // Index 80
    JLINKARM_CORTEX_R8_REG_SPSR,        // Index 81 (0x51)
    JLINKARM_CORTEX_R8_REG_D16,         // Index 82 (0x52), 64-bit only. Only available on CPUs with implement VFP with D16-D31
    JLINKARM_CORTEX_R8_REG_D17,         // Index 83 (0x53), 64-bit only. Only available on CPUs with implement VFP with D16-D31
    JLINKARM_CORTEX_R8_REG_D18,         // Index 84 (0x54), 64-bit only. Only available on CPUs with implement VFP with D16-D31
    JLINKARM_CORTEX_R8_REG_D19,         // Index 85 (0x55), 64-bit only. Only available on CPUs with implement VFP with D16-D31
    JLINKARM_CORTEX_R8_REG_D20,         // Index 86 (0x56), 64-bit only. Only available on CPUs with implement VFP with D16-D31
    JLINKARM_CORTEX_R8_REG_D21,         // Index 87 (0x57), 64-bit only. Only available on CPUs with implement VFP with D16-D31
    JLINKARM_CORTEX_R8_REG_D22,         // Index 88 (0x58), 64-bit only. Only available on CPUs with implement VFP with D16-D31
    JLINKARM_CORTEX_R8_REG_D23,         // Index 89 (0x59), 64-bit only. Only available on CPUs with implement VFP with D16-D31
    JLINKARM_CORTEX_R8_REG_D24,         // Index 90 (0x5A), 64-bit only. Only available on CPUs with implement VFP with D16-D31
    JLINKARM_CORTEX_R8_REG_D25,         // Index 91 (0x5B), 64-bit only. Only available on CPUs with implement VFP with D16-D31
    JLINKARM_CORTEX_R8_REG_D26,         // Index 92 (0x5C), 64-bit only. Only available on CPUs with implement VFP with D16-D31
    JLINKARM_CORTEX_R8_REG_D27,         // Index 93 (0x5D), 64-bit only. Only available on CPUs with implement VFP with D16-D31
    JLINKARM_CORTEX_R8_REG_D28,         // Index 94 (0x5E), 64-bit only. Only available on CPUs with implement VFP with D16-D31
    JLINKARM_CORTEX_R8_REG_D29,         // Index 95 (0x5F), 64-bit only. Only available on CPUs with implement VFP with D16-D31
    JLINKARM_CORTEX_R8_REG_D30,         // Index 96 (0x60), 64-bit only. Only available on CPUs with implement VFP with D16-D31
    JLINKARM_CORTEX_R8_REG_D31,         // Index 97 (0x61), 64-bit only. Only available on CPUs with implement VFP with D16-D31
    JLINKARM_CORTEX_R8_NUM_REGS
} JLINKARM_CORTEX_R8_REG;
...
typedef enum {
  ...
  //
    JLINK_ARM_V8AR_REG_R0,          //     0    
    JLINK_ARM_V8AR_REG_R1,          //     1    
    JLINK_ARM_V8AR_REG_R2,          //     2    
    JLINK_ARM_V8AR_REG_R3,          //     3    
    JLINK_ARM_V8AR_REG_R4,          //     4    
    JLINK_ARM_V8AR_REG_R5,          //     5    
    JLINK_ARM_V8AR_REG_R6,          //     6    
    JLINK_ARM_V8AR_REG_R7,          //     7    
    JLINK_ARM_V8AR_REG_R8,          //     8    
    JLINK_ARM_V8AR_REG_R9,          //     9    
    JLINK_ARM_V8AR_REG_R10,         //    10   
    JLINK_ARM_V8AR_REG_R11,         //    11   
    JLINK_ARM_V8AR_REG_R12,         //    12   
    JLINK_ARM_V8AR_REG_R13,         //    13   
    JLINK_ARM_V8AR_REG_R14,         //    14   
    JLINK_ARM_V8AR_REG_R15,         //    15   
    JLINK_ARM_V8AR_REG_R16,         //    16   
    JLINK_ARM_V8AR_REG_R17,         //    17   
    JLINK_ARM_V8AR_REG_R18,         //    18   
    JLINK_ARM_V8AR_REG_R19,         //    19   
    JLINK_ARM_V8AR_REG_R20,         //    20   
    JLINK_ARM_V8AR_REG_R21,         //    21   
    JLINK_ARM_V8AR_REG_R22,         //    22   
    JLINK_ARM_V8AR_REG_R23,         //    23   
    JLINK_ARM_V8AR_REG_R24,         //    24   
    JLINK_ARM_V8AR_REG_R25,         //    25   
    JLINK_ARM_V8AR_REG_R26,         //    26   
    JLINK_ARM_V8AR_REG_R27,         //    27   
    JLINK_ARM_V8AR_REG_R28,         //    28   
    JLINK_ARM_V8AR_REG_R29,         //    29   FP
    JLINK_ARM_V8AR_REG_R30,         //    30   LR
    JLINK_ARM_V8AR_REG_R31,         //    31   NOT USED in armv8a! XZR 'zero register'
    JLINK_ARM_V8AR_REG_SP,          //    32   
    JLINK_ARM_V8AR_REG_PC,          //    33   
    JLINK_ARM_V8AR_REG_ELR_EL1,     //    34   
    JLINK_ARM_V8AR_REG_ELR_EL2,     //    35   
    JLINK_ARM_V8AR_REG_ELR_EL3,     //    36   
    JLINK_ARM_V8AR_REG_SP_EL0,      //    37   
    JLINK_ARM_V8AR_REG_SP_EL1,      //    38   
    JLINK_ARM_V8AR_REG_SP_EL2,      //    39   
    JLINK_ARM_V8AR_REG_SP_EL3,      //    40   
    JLINK_ARM_V8AR_REG_CPSR,        //    41   DOESN'T EXIST IN aarch64! This is simulated by JLink
    JLINK_ARM_V8AR_REG_SPSR_abt,    //    42   
    JLINK_ARM_V8AR_REG_SPSR_EL1,    //    43   32-bit
    JLINK_ARM_V8AR_REG_SPSR_EL2,    //    44   32-bit
    JLINK_ARM_V8AR_REG_SPSR_EL3,    //    45   32-bit
    JLINK_ARM_V8AR_REG_SPSR_fiq,    //    46   32-bit
    JLINK_ARM_V8AR_REG_SPSR_irq,    //    47   32-bit
    JLINK_ARM_V8AR_REG_SPSR_und,    //    48   32-bit
    //                                         
    // Floating point (32-bit)                 
    //                                         
    JLINK_ARM_V8AR_REG_FPCR,        //    49   
    JLINK_ARM_V8AR_REG_FPSR,        //    50   
    //                                         
    // Floating point (128-bit, split into LOW/HIGH 64-bit parts)
    //                                         
    JLINK_ARM_V8AR_REG_V0_LOW,      //    51   
    JLINK_ARM_V8AR_REG_V0_HIGH,     //    52   
    JLINK_ARM_V8AR_REG_V1_LOW,      //    53   
    JLINK_ARM_V8AR_REG_V1_HIGH,     //    54   
    JLINK_ARM_V8AR_REG_V2_LOW,      //    55   
    JLINK_ARM_V8AR_REG_V2_HIGH,     //    56   
    JLINK_ARM_V8AR_REG_V3_LOW,      //    57   
    JLINK_ARM_V8AR_REG_V3_HIGH,     //    58   
    JLINK_ARM_V8AR_REG_V4_LOW,      //    59   
    JLINK_ARM_V8AR_REG_V4_HIGH,     //    60   
    JLINK_ARM_V8AR_REG_V5_LOW,      //    61   
    JLINK_ARM_V8AR_REG_V5_HIGH,     //    62   
    JLINK_ARM_V8AR_REG_V6_LOW,      //    63   
    JLINK_ARM_V8AR_REG_V6_HIGH,     //    64   
    JLINK_ARM_V8AR_REG_V7_LOW,      //    65   
    JLINK_ARM_V8AR_REG_V7_HIGH,     //    66   
    JLINK_ARM_V8AR_REG_V8_LOW,      //    67   
    JLINK_ARM_V8AR_REG_V8_HIGH,     //    68   
    JLINK_ARM_V8AR_REG_V9_LOW,      //    69   
    JLINK_ARM_V8AR_REG_V9_HIGH,     //    70   
    JLINK_ARM_V8AR_REG_V10_LOW,     //    71   
    JLINK_ARM_V8AR_REG_V10_HIGH,    //    72   
    JLINK_ARM_V8AR_REG_V11_LOW,     //    73   
    JLINK_ARM_V8AR_REG_V11_HIGH,    //    74   
    JLINK_ARM_V8AR_REG_V12_LOW,     //    75   
    JLINK_ARM_V8AR_REG_V12_HIGH,    //    76   
    JLINK_ARM_V8AR_REG_V13_LOW,     //    77   
    JLINK_ARM_V8AR_REG_V13_HIGH,    //    78   
    JLINK_ARM_V8AR_REG_V14_LOW,     //    79   
    JLINK_ARM_V8AR_REG_V14_HIGH,    //    80   
    JLINK_ARM_V8AR_REG_V15_LOW,     //    81   
    JLINK_ARM_V8AR_REG_V15_HIGH,    //    82   
    JLINK_ARM_V8AR_REG_V16_LOW,     //    83   
    JLINK_ARM_V8AR_REG_V16_HIGH,    //    84   
    JLINK_ARM_V8AR_REG_V17_LOW,     //    85   
    JLINK_ARM_V8AR_REG_V17_HIGH,    //    86   
    JLINK_ARM_V8AR_REG_V18_LOW,     //    87   
    JLINK_ARM_V8AR_REG_V18_HIGH,    //    88   
    JLINK_ARM_V8AR_REG_V19_LOW,     //    89   
    JLINK_ARM_V8AR_REG_V19_HIGH,    //    90   
    JLINK_ARM_V8AR_REG_V20_LOW,     //    91   
    JLINK_ARM_V8AR_REG_V20_HIGH,    //    92   
    JLINK_ARM_V8AR_REG_V21_LOW,     //    93   
    JLINK_ARM_V8AR_REG_V21_HIGH,    //    94   
    JLINK_ARM_V8AR_REG_V22_LOW,     //    95   
    JLINK_ARM_V8AR_REG_V22_HIGH,    //    96   
    JLINK_ARM_V8AR_REG_V23_LOW,     //    97   
    JLINK_ARM_V8AR_REG_V23_HIGH,    //    98   
    JLINK_ARM_V8AR_REG_V24_LOW,     //    99   
     JLINK_ARM_V8AR_REG_V24_HIGH,   //    100  
     JLINK_ARM_V8AR_REG_V25_LOW,    //    101  
     JLINK_ARM_V8AR_REG_V25_HIGH,   //    102  
     JLINK_ARM_V8AR_REG_V26_LOW,    //    103  
     JLINK_ARM_V8AR_REG_V26_HIGH,   //    104  
     JLINK_ARM_V8AR_REG_V27_LOW,    //    105  
     JLINK_ARM_V8AR_REG_V27_HIGH,   //    106  
     JLINK_ARM_V8AR_REG_V28_LOW,    //    107  
     JLINK_ARM_V8AR_REG_V28_HIGH,   //    108  
     JLINK_ARM_V8AR_REG_V29_LOW,    //    109  
     JLINK_ARM_V8AR_REG_V29_HIGH,   //    110  
     JLINK_ARM_V8AR_REG_V30_LOW,    //    111  
     JLINK_ARM_V8AR_REG_V30_HIGH,   //    112  
     JLINK_ARM_V8AR_REG_V31_LOW,    //    113  
     JLINK_ARM_V8AR_REG_V31_HIGH,   //    114  
     //
...
typedef enum {
  ...
  JLINK_IFUNC_EMU_FILE_GET_FILE_INFO,
  JLINK_IFUNC_EMU_FILE_GET_DIR_ENTRIES,
  JLINK_IFUNC_EMU_FILE_MOVE,
  JLINK_IFUNC_UART_INIT,
  JLINK_IFUNC_UART_WRITE,
  JLINK_IFUNC_UART_READ,
  JLINK_IFUNC_UART_DEINIT,
  JLINK_IFUNC_PCODE_DATA_DOWNLOAD_EX,
...
typedef int (STDCALL* JLINK_FUNC_UART_INIT_ptr)(U32 BaudrateHz, U32 Flags);
typedef int (STDCALL* JLINK_FUNC_UART_WRITE_ptr)(const void* pData, U32 NumBytes);
typedef int (STDCALL* JLINK_FUNC_UART_READ_ptr)(void* pData, U32 NumBytes, U32 Timeout);
typedef int (STDCALL* JLINK_FUNC_UART_DEINIT_ptr)(void);
