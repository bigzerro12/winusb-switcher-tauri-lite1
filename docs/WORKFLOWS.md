...
- Linux stores logs under `$XDG_DATA_HOME/com.winusbswitcher.lite/logs/` and WebView data under `$XDG_DATA_HOME/com.winusbswitcher.lite/webview/` (fallback `~/.local/share/...`).
